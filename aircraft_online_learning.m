...
%gam1 = 18.1849 
%gam2 = 6.1621 
%[kappa,tau, C, delta, Pi, mu, alpha] = get_bounds2(gam1, gam2, 0.99) 
% ora ho il dataset offline U_-1, X_-1 and X0 e vado online da k=0 
...
for t=0:time 
   ...
   cvx_begin sdp quiet 
    ...
    %formo la mia u(t) e salvo u(t) e x(t) 
    ...
    u = K*x + norm(x)*e; 
        ...
        %%%% 
    x = As*x+Bs*u;  
    %aggiorno la x(t+1) e u(t) per il next step 
    U = [U, u]; 
    X = [X, x]; 
end 
 
%% 
colors = {'#ff9100','#1e96fc' }; % orange 1c77c3 7f95d1 
figure 
subplot 211 
box on 
for j = 1:n 
